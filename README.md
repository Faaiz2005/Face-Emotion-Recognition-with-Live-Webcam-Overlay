...
├── README.md                         # This file
├── class_distribution.png            # Generated during training
├── preprocessing_pipeline.png        # Generated during training
└── demo_clip.avi                     # 30-second annotated demo (generated by script)
```
...
```bash
python test_on_images.py --folder ./test_images/
```
...
Run the webcam mode and the script auto-saves a 30-second annotated clip as `demo_clip.avi`.
